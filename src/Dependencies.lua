...
gFrames = {
    ...
    ['metal'] = {
        ...
        love.graphics.newQuad(0, 35, 110, 35, gTextures['metal']:getDimensions()),
        love.graphics.newQuad(320, 180, 35, 110, gTextures['metal']:getDimensions()),
        love.graphics.newQuad(355, 355, 35, 110, gTextures['metal']:getDimensions())
    },
    ['explosive'] = {
        love.graphics.newQuad(0, 0, 110, 35, gTextures['explosive']:getDimensions()),
        love.graphics.newQuad(0, 35, 110, 35, gTextures['explosive']:getDimensions()),
        love.graphics.newQuad(320, 180, 35, 110, gTextures['explosive']:getDimensions()),
        love.graphics.newQuad(355, 355, 35, 110, gTextures['explosive']:getDimensions())
    }
}
